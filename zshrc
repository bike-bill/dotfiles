...
plugins=(alias-finder aliases archlinux aws docker docker-compose doctl dotenv git gitfast nvm terraform zsh-autosuggestions zsh-completions zsh-syntax-highlighting)
